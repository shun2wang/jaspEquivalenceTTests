    ...
    if (!isFALSE(errors[[namePair]])) {
      ...
      if (isTryError(tableResults)) {
        ...
        results[[namePair]] <- list(
          ...
          upperTvalue = tableResults$tost$asDF$t[2],
          upperDf     = tableResults$tost$asDF$df[2],
          upperP      = tableResults$tost$asDF$p[2],
          lowerTvalue = tableResults$tost$asDF$t[3],
          lowerDf     = tableResults$tost$asDF$df[3],
          lowerP      = tableResults$tost$asDF$p[3],
